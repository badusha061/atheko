...
function ContactHome() {
  ...
  return (
    <section className="bg-white dark:bg-gray-900 py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center relative px-4 py-10">
            <div className="w-[800px]  max-w-4xl  h-[600px]  rounded-3xl border-2 border-[#BA00FF]">
                
                <div className='  sm:absolute   sm:right-80  sm:w-[400px]' >
                ...
                <form  onSubmit={form.handleSubmit(handleSubmitButton)}>
                    ...
                    <div className='' >
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                <FormLabel className={`${inter.className} block mb-2 text-sm text-gray-600 dark:text-gray-200`} >Full Name</FormLabel>
                                <FormControl>
                        ...
                        <div>
                         ...
                         <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                    <FormLabel className={`${inter.className} block mb-2 text-sm text-gray-600 dark:text-gray-200`} >Phone Number</FormLabel>
                                    <FormControl>
                        ...
                        <div>
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                    <FormLabel className={`${inter.className} block mb-2 text-sm text-gray-600 dark:text-gray-200`} >Email Address</FormLabel>
                                    <FormControl>
            ...
            <div className="hidden sm:flex absolute left-0 right-0 bottom-32 w-[300px] h-[400px] rounded-3xl bg-[linear-gradient(to_right,_#5116E3,_#BA00FF)] flex-col justify-center items-center px-4 text-center space-y-4">
                <h1 className={`${inter.className} text-white text-lg font-semibold`}>
                CONTACT
                </h1>
                <h1 className={`${inter.className} text-white text-2xl font-semibold`}>
                INFORMATION
                </h1>

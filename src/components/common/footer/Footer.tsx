        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                ...
                <div className="flex flex-col gap-3 text-sm text-gray-500">
                    ...
                    <span className={inter.className}>903 7878 914</span>
                    </div>

                    <div className="flex items-center gap-2">
                    <PhoneForwarded className="min-w-[20px]" color="black" />
                    <span className={inter.className}>903 7898 916</span>
                    </div>
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex  items-center gap-5    justify-center flex-col lg:justify-start lg:flex-row">
                    ...
                    <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        <a href="https://www.instagram.com/atheko_premium_laundry/profilecard/?igsh=eTg5Zno0dngxZ3Zt"  className="w-9 h-9 rounded-full bg-[linear-gradient(to_right,_#5116E3,_#BA00FF)] flex justify-center items-center hover:bg-[linear-gradient(to_right,_#5116E3,_#BA00FF)]0">
                    ...
                    <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        <a href="https://www.facebook.com/profile.php?id=61578674197610&notif_id=1753626217798076&notif_t=fan_profile_v2&ref=notif"  className="w-9 h-9 rounded-full bg-[linear-gradient(to_right,_#5116E3,_#BA00FF)] flex justify-center items-center hover:bg-[linear-gradient(to_right,_#5116E3,_#BA00FF)]0">
                            <Facebook  color="white" />
                        </a>
                    </div>
                    <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        <a href="https://www.linkedin.com/company/atheko/"  className="w-9 h-9 rounded-full bg-[linear-gradient(to_right,_#5116E3,_#BA00FF)] flex justify-center items-center hover:bg-[linear-gradient(to_right,_#5116E3,_#BA00FF)]0">

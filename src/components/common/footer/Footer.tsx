        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    ...
                    <p className={`${inter.className} py-2 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left`}>1st Floor, Jalsu Centre, Kannur Rd, West Hill, Calicut, India - 673005</p>
                    <p className={`${inter.className} py-2 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left`}>903 7878 914</p>
                    <p className={`${inter.className} mb-4 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left`}>903 7898 916</p>
                    <Link href="/contact">
                      <Button className={` ${inter.className} py-2.5 px-5 h-9 block w-fit bg-[linear-gradient(to_right,_#5116E3,_#BA00FF)] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0`}>
                          Contact us
                      </Button>
                    </Link>
                </div>
